                    ...
                    <div className="row g-4 justify-content-center">
                        ...
                        <div className="col-md-4">
                            <div className="bg-white rounded-4 shadow-lg text-center px-4 py-5 h-100 position-relative">
                                ...
                                <div className="text-decoration-line-through text-muted small">590.000đ</div>
                                <div
                        ...
                        <div className="col-md-4">
                            ...
                            >
                                ...
                                <div className="text-decoration-line-through text-muted small">390.000đ</div>
                                <div
                        ...
                        <div className="col-md-4">
                            <div className="bg-white rounded-4 shadow-lg text-center px-4 py-5 h-100 position-relative">
                                ...
                                <div className="text-decoration-line-through text-muted small">790.000đ</div>
                                <div
                                    className="fw-bold fs-3 text-white mb-3"
                                    style={{ backgroundColor: '#00C853', padding: '10px 0', borderRadius: '4px' }}
                                >
