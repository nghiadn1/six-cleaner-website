...
=======
  ...
  import ChangePassword from "./pages/ChangePassword"; // hoặc đường dẫn tương ứng
    ...
    return (
      <>
        ...
        <Routes>
          ...
          <Route path="/dat-dich-vu" element={<Information />} />
          <Route
            path="/house-service-detail"
            element={<HouseServiceDetail />}
          />
          <Route path="/chi-tiet-thanh-toan" element={<PaymentPage />} />
          <Route path="/lich-su-dat-lich" element={<BookingHistory />} />
          <Route path="/ho-so-ca-nhan" element={<ProfilePage />} />
  ...
  export default App;
>>>>>>> 4b3c445080f5939f172bf75083b30f2f216acf0b
